exports.seed = function(knex, Promise) {
  return Promise.all([
    ...
    knex('posts').insert({
      ...
      body: 'Im sure everyone in the world i laughing at us right now',
      user_id: 2,
    ...
    knex('posts').insert({
      ...
      body: 'If Trump would have put the same $ his dad gave him, he\'d have the same amount of money by now',
      user_id: 3,
